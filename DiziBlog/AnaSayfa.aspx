<%@ Page Title="" Language="C#" MasterPageFile="~/Kullanıcı.Master" AutoEventWireup="true" CodeBehind="AnaSayfa.aspx.cs" Inherits="DiziBlog.AnaSayfa" %>
                    ...
                    <div class="categories">
                        ...
                        <ul>
                            ...
                            <asp:Repeater ID="Repeater2" runat="server">
                                <ItemTemplate>
                                    <li><a href="KategoriKısıt.Aspx?Id=<%# Eval("Id") %>"><%# Eval("Kategori") %></a></li>
                                </ItemTemplate>
                            </asp:Repeater>
                        </ul>
                    </div>
